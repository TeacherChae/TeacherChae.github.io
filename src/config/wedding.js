...
export const wedding = {
  ...
  gallery: [
    { src: '/images/gallery-01.jpg', alt: '부케를 든 신부와 함께한 야경 웨딩 사진' },
    { src: '/images/gallery-02.jpg', alt: '베일 위에 놓인 웨딩 소품' },
    { src: '/images/gallery-03.jpg', alt: '잔디 위에서 함께 앉은 두 사람' },
    { src: '/images/gallery-04.jpg', alt: '스파클러를 든 두 사람의 야경 사진' },
    { src: '/images/gallery-05.jpg', alt: '촛불을 들고 마주 선 두 사람' },
    { src: '/images/gallery-06.jpg', alt: '정류장 앞에 함께 앉은 두 사람' },
    { src: '/images/gallery-07.jpg', alt: '도시 야경 앞에서 함께 선 두 사람' },
    { src: '/images/gallery-08.jpg', alt: '도시 야경을 바라보는 두 사람' },
    { src: '/images/gallery-09.jpg', alt: '밤거리에서 서로를 바라보는 두 사람' },
    { src: '/images/gallery-10.jpg', alt: '석양길을 함께 걷는 두 사람' },
    { src: '/images/gallery-11.jpg', alt: '다리 위를 함께 걷는 두 사람' },
    { src: '/images/gallery-12.jpg', alt: '잔디 위에 누운 두 사람' },
    { src: '/images/gallery-13.jpg', alt: '잔디 위에서 서로를 바라보는 두 사람' },
    { src: '/images/gallery-14.jpg', alt: '베일을 쓴 신부의 야외 웨딩 사진' },
    { src: '/images/gallery-15.jpg', alt: '잔디밭에서 마주 선 두 사람' },
    { src: '/images/gallery-16.jpg', alt: '베일을 잡고 선 두 사람의 뒷모습' },
    { src: '/images/gallery-17.jpg', alt: '숲길에서 부케를 든 신부' },
    { src: '/images/gallery-18.jpg', alt: '잔디밭을 함께 걷는 두 사람' },
    { src: '/images/gallery-19.jpg', alt: '결혼 날짜 풍선과 함께한 두 사람' },
    { src: '/images/gallery-20.jpg', alt: '초록 잔디 위 베일을 든 두 사람' },
    { src: '/images/gallery-21.jpg', alt: '숲속에서 포옹하는 두 사람' },
    { src: '/images/gallery-22.jpg', alt: '베일 아래 부케를 든 신부' },
    { src: '/images/gallery-23.jpg', alt: '나무 아래 앉아 있는 두 사람' },
    { src: '/images/gallery-24.jpg', alt: '잔디밭에서 손을 맞잡은 두 사람' },
    { src: '/images/gallery-25.jpg', alt: '결혼 날짜 풍선 앞에 선 두 사람' },
    { src: '/images/gallery-26.jpg', alt: '숲속에서 신부를 안아 든 신랑' },
    { src: '/images/gallery-27.jpg', alt: '초록 배경 앞에 나란히 선 두 사람' },
    { src: '/images/gallery-28.jpg', alt: '드레스를 입고 앉은 신부' },
    { src: '/images/gallery-29.jpg', alt: '숲속에서 부케를 든 신랑' },
    { src: '/images/gallery-30.jpg', alt: '잔디밭에서 손을 맞잡은 두 사람의 클로즈업' },
  ],
  share: {
